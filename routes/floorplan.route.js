...
router.get(
  "/:floorplanId",
  FloorplanController.getSpecificFloorplanForGivenProject
);
...
router.delete(
  "/:floorplanId",
  FloorplanController.deleteSpecificFloorplanForGivenProject
);
...
router.post(
  "/",
  upload.single("file"),
  FloorplanController.createFloorplanForGivenProject
);
...
router.patch(
  "/:floorplanId",
  upload.single("file"),
  FloorplanController.updateFloorplanForGivenProject
);
