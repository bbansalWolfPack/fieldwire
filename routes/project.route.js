...
* @apiSuccess (200) {Object} success message
*/
router.post('/', validator.validateProjectRequest, ProjectController.postProject);
...
* @apiSuccess (200) {Object} success message
*/
router.patch('/:id', validator.validateProjectRequest, ProjectController.patchProject);
